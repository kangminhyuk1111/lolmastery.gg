...
function NoticePage() {
    ...
    const {data, isLoading, isError} = useQuery<any[]>('notice-data', getNoticeDb)
        ...
        <div className={"App"}>
            <div className='main-wrapper community'>
                ...
                <div className={'community-board-div'}>
                    {isLoading ? <span>Loaindg...</span> : null}
